...
const cartQuantity = document.querySelector('.cart__qantity');
...
const generateCartProduct = (img, title, price, id) => {
    ...
    <article class="cart-content__product cart-product" data-id="${id}">
        <img src="${img}" alt="Ноутбук" class="cart-product__img">
        <div class="cart-product__text">
            <h3 class="cart-product__title">${title}</h3>
            <span class="cart-product__price">${normalPrice(price)}P</span>
        </div>
...
productBtn.forEach(el => {
    ...
    let img  = parent.querySelector(".image-switch__img").firstElementChild.getAttribute('src');
